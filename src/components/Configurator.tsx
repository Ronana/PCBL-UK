...
import { BasePCSystem, SelectedComponents, BasketItem, User, ConfiguratorSection } from '../types';
...
const Configurator: React.FC<ConfiguratorProps> = ({ baseSystem, onBack, onAddToBasket, onSaveBuild, initialComponents, user, configuratorSections }) => {
    ...
    }, [baseSystem.brand, configuratorSections]);
